...
const SKILL_ICON_MAP: Record<string, string> = {
  ...
  // File contains a '#' - use encoded URL to avoid fragment issues
  "C# (basic)": "/icons/C%23%20%28CSharp%29.svg",
    ...
    <Section id="about" className="py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-3 max-w-3xl text-zinc-600 dark:text-zinc-400">
          I’m a Junior Software Engineer passionate about problem solving and
          learning. I focus on strong software engineering fundamentals: clean
          code, testing, version control, and readable documentation. Im eager
          to contribute to real-world projects and grow alongside a supportive
          team.
        </p>
        ...
        <div className="mt-10">
          ...
          <ul className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
            {skills.map((name) => {
              const icon =
                SKILL_ICON_MAP[name] ||
                SKILL_ICON_MAP[name.replace(/\s+/g, "")];
              return (
                <li
                  key={name}
                  className="group rounded-lg border border-zinc-200 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950/70"
                >
        ...
        <div className="mt-12">
          ...
          <div className="mt-3 rounded-lg border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950/70">
